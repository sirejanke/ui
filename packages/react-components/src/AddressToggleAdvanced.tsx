...
function AddressToggleAdvanced ({ address, className = '', filter, isHidden, noToggle, onChange, value }: Props): React.ReactElement<Props> | null {
  const { api } = useApi();
...
export default React.memo(styled(AddressToggleAdvanced)`
